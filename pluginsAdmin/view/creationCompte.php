...
<body>
	...
	<div class="jumbotron col-md-8 col-md-offset-2 text-center">
  			<h1>CREATION DU COMPTE SUPER ADMINISTRATEUR</h1>
	</div>
	...
	<div class="row">
		...
		<div class="col-md-10 col-md-offset-1">
			<form class="form-horizontal col-md-4 col-md-offset-4" id="formAjout" action="./pluginsAdmin/controller/superAdmin.php" method="post">
